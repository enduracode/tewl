...
public static class DateTimeTools {
	...
	public static string ToMonthDayYearString( this DateTime? dateTime, string stringIfNull ) =>
		dateTime.HasValue ? ToMonthDayYearString( dateTime.Value ) : stringIfNull;
	...
	public static string ToHourAndMinuteString( this DateTime? dateTime, string stringIfNull ) =>
		dateTime.HasValue ? ToHourAndMinuteString( dateTime.Value ) : stringIfNull;
	...
	/// </summary>
	public static DateTime MonthBeginDate( this DateTime date ) => new( date.Year, date.Month, 1 );
