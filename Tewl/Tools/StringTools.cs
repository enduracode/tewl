...
public static class StringTools {
	...
	/// <summary>
	/// Returns true if this string matches the given search terms.
	/// </summary>
	...
	/// </summary>
	public static string ToAcronym( this string s ) => new( s.Separate().Select( i => i.First() ).ToArray() );
	...
	// ReSharper disable GrammarMistakeInComment
	/// <summary>
	/// Prepends either “a ” or “an ” to this English word, based on Wikipedia usage data. Implemented with https://eamonnerbonne.github.io/a-vs-an/.
	/// </summary>
	...
	/// this can affect the result.</param>
	/// <returns></returns>
	// ReSharper restore GrammarMistakeInComment
